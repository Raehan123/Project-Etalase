                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('kategoritokoh.store') }}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" name="id" value="{{ $kategori_tokohs->id }}">
                                    <input type="text" value="{{ $kategori_tokohs->nama }}" name="nama" id="nama" class="form-control col-md-8" required>
                                </div>
