                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('produk.store') }}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" name="stok" id="stok" class="form-control col-md-8" required>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" name="min_stok" id="min_stok" class="form-control col-md-8" required>
                                </div>
                                <div class="form-group row">
                                    <label for="jenis_produk_id" class="col-md-4">Jenis Produk id</label>
                                    <select name="jenis_produk_id" id="jenis_produk_id" class="form-control col-md-8">
